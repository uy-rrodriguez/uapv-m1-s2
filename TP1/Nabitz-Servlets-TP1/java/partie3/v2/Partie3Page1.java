...
public class Partie3Page1 extends HttpServlet {

	private void doRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String style = "<link rel='stylesheet' type='text/css' href='../css/style.css'>";
		String header = "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>Partie 3, Page bidon 1</title>" + style + "</head><body>";
		String footer = "</body></html>";
				
		String contenu = "<div id='container'>"
						+ "		<h3>Page bidon 1</h3>"
						+ "		<a href='Partie3Page2'>Page suivante</a>"
