...
#$console.BufferSize            = 120,3000

#$pos = $console.WindowPosition
#$pos.Y = 0
#$pos.X = 462
#console.WindowPosition = $pos
...
#$console.MaxWindowSize         = 120,58
#$console.MaxPhysicalWindowSize = 194,58
#$console.KeyAvailable          = True
#$console.WindowTitle           = Windows PowerShell

Set-Location G:\Dev\RepoGit\uapv-m1-s1\Serveur\src\
